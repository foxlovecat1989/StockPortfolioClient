...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  private initStocksList(): Subscription {
    return this.stockService.getStocks().subscribe(
  ...
  private initUser(user: User): Subscription {
    return this.authenticationService.login(user).subscribe(
